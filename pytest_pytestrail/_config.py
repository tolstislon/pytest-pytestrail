...
class Config:
    ...
    def __init__(self, conf) -> None:
        ...
        self.testrun_name = conf.getoption('--tr-testrun-name') or conf.getini('pytestrail-testrun-name')
        self.date_format = conf.getoption('--tr-date-format') or conf.getini('pytestrail-date-format')
